...
#define OPCODE_ADD    0xF
#define OPCODE_ADDI   0xE
#define OPCODE_SUB    0xD
#define OPCODE_SLL    0xC
#define OPCODE_SRL    0xB
#define OPCODE_AND    0xA
#define OPCODE_XOR    0x9
#define OPCODE_LW     0x8
#define OPCODE_SW     0x7
#define OPCODE_BEQ    0x6
#define OPCODE_BGT    0x5
#define OPCODE_J      0x4
#define OPCODE_JR     0x3
#define OPCODE_JAL    0x2
#define OPCODE_INPUT  0x1
#define OPCODE_OUTPUT 0x0

// NOTE: If changing between 'bne' and 'beq', change the code at the
//  comment "SET UP YOUR HALT HERE" in asm.cpp

/////////////////////////////////////////////////////////////////////////////////
// unsupported opcodes preserved so we can adapt this kit year to year
#define OPCODE_OR     0x60
#define OPCODE_NOT    0x61
#define OPCODE_SHRA    0x62
#define OPCODE_SHL   0x63
#define OPCODE_BLE    0x64
#define OPCODE_SHR    0x65
#define OPCODE_BEQZ    0x66
#define OPCODE_NOR    0x67
#define OPCODE_NAND   0x68
//#define OPCODE_LW     0x67
//#define OPCODE_SW     0x68
//#define OPCODE_BEQ    0x6A
...
instruction_t opcode_arr[] = {
    ...
    instruction_t(OPCODE_SRL,   "srl",    RSH), 
    ...
    instruction_t(OPCODE_BGT,   "bgt",    IBranchComp),
