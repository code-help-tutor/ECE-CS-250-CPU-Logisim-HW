...
prime_subloop_end:
    ...
    #    if (prime) print x
    # bne $r5, $r0, prime_printx_then
    # j prime_printx_endif
    beq $r5, $r0, prime_printx_endif
prime_printx_then:    
...
puts_loop:
    lw $r2, 0($r1)
    # bne $r2, $r0, puts_loop_keepgoing
    # j puts_loop_end
    beq $r2, $r0, puts_loop_end
puts_loop_keepgoing:
    output $r2
    addi $r1, $r1, 1
    j puts_loop
